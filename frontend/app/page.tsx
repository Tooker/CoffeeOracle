...
export default function Home() {
  return (
    <section className="oracle-mist relative overflow-hidden space-y-6 rounded-3xl border-0 bg-coffee-night/80 p-2 shadow-oracle sm:space-y-8 sm:p-4 lg:border lg:border-white/10 lg:p-8">
      <div className="oracle-load-block oracle-load-block-title space-y-4">
      ...
      <p className="oracle-load-block oracle-load-block-copy max-w-3xl text-base text-coffee-foam/80">
